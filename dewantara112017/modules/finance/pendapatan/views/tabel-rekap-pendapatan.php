...
<table class="tabelvendor table table-hover table-striped table-condensed">
	 <thead class="">
                                        <tr>
                                            ...
                                            <th style="width:10%;display: table-cell;text-align: center;vertical-align: middle;">Kode</th>
                                            <th style="width:50%;display: table-cell;text-align: center;vertical-align: middle;">Pendapatan</th>
...
<script type="text/javascript">
		...
		$(".tabelvendor").DataTable({
                "ajax": {
                    "url": baseurl + 'laporan/getrekappendapatan/',
                    "dataType": "json",
                    "data": dtx
                    ,
                },
