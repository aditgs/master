...
<table class="tabelvendor table table-hover table-striped table-condensed display compact" style="width:100%">
	<thead class="">
	 	<tr>
            ...
            <th style="width:20%;text-align:center;vertical-align: middle;">Kode/Nama Vendor</th>
		...
		<?php 
		 ...
		 ?>
				<table class="table table-hover table-bordered table-striped table-condensed display compact" style="width:100%">
					<thead class="compact">
						<tr>
							<td style="width:10%;text-align:center;vertical-align: middle;">Tanggal</td>
							<td style="width:10%;text-align:center;vertical-align: middle;">Tempo</td>
							<td style="width:20%;text-align:center;vertical-align: middle;">Faktur</td>
						...
						<tr style="font-weight:bold">
							...
							<td>Pendapatan</td>
							<td>Keterangan</td>
							<td class="text-center" style="text-center">Rekening</td>
					...
					<tbody>
						...
						?>
							...
							<tr>
								...
								<td class="text-center" style="text-align:center"><?php echo !empty($val['rekening'])?$val['rekening']:'-' ?></td>
					...
					<tfoot>
						<tr>
							<td colspan="5" class="text-right" style="text-align:right"><h4>Total Pendapatan Vendor:</h4></td>
							<?php if(!empty($data['kdvendor'])||$data['kdvendor']!=null): ?>
