<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div <?php ( ! empty($message)) && print( 'class="alert alert-info"'); ?> id="infoMessage">
            <?php echo $message;?>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <p>
            <?php //echo bs_form_submit('submit', lang('create_user_submit_btn'));?>
        </p>
        <p>
            <?php echo bs_form_submit('submit', 'Daftar');?>
        </p>
    </div>
    <?php echo form_close();?>
</div>