        ...
        <article>
            ...
            <table>
                <thead>  <tr>
                    ...
                    <th colspan="3"><h2>KARTU PESERTA</h2>
                        <h3>SELEKSI PMB GELOMBANG I</h3>
                        <h4>STIE PGRI DEWANTARA JOMBANG TA. 2018/2019</h4>
            ...
            <div class="row gutter5">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div style="display:block;float:left;border:1px solid #333;min-width: 30mm;min-height: 4mm; width: 150px;height:200px;"></div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            ...
                            <?php echo date("d M Y", strtotime($detail['date_seleksi_start'])); ?>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <?php echo date("d M Y", strtotime($detail['date_pengumuman'])); ?>
                </div>
