    ...
    function __save(){
       ...
       $data = array(
            ...
            'kode_prodi' => $this->input->post('kode_prodi', TRUE), //valid
             ...
             'tgl_cmhs' => !empty($this->input->post('tgl_cmhs'))?tglid($this->input->post('tgl_cmhs', TRUE)):null,
             ...
             'tgl_ijazah_pend' => ($this->input->post('tgl_ijazah_pend') != FALSE) ? tglid($this->input->post('tgl_ijazah_pend')) : NULL,
             ...
             'tgl_transfer' => ($this->input->post('tgl_transfer') != FALSE) ? tglid($this->input->post('tgl_transfer')) : NULL, //valid
    ...
    function __saveas(){
       ...
       $data = array(
            ...
            'kode_prodi' => $this->input->post('kode_prodi', TRUE),
             ...
             'id_siakad_keu_rek' => $this->input->post('id_siakad_keu_rek', TRUE),
             'id_siakad_keu_pendaftaran' => $this->input->post('id_siakad_keu_pendaftaran', TRUE),
             'tgl_transfer' => ($this->input->post('tgl_transfer') != FALSE) ? tglid($this->input->post('tgl_transfer')) : NULL,
             'nm_transfer' => $this->input->post('nm_transfer', TRUE),
             'img_bukti_transfer' => $this->input->post('img_bukti_transfer', TRUE),
             'img_pasfoto' => $this->input->post('img_pasfoto', TRUE),
             'img_id' => $this->input->post('img_id', TRUE),
