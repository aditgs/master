...
<div id="form_input" class="row gutter5">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <?php echo form_input('Kodek',set_value('Kodek', isset($default['Kodek']) ? $default['Kodek'] : ''),'id="Kodek" class="text-center form-control" placeholder="AUTO" readonly '); ?>
            </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <button id="save_edit" type="submit" data-dismiss="modal" class="btn btn-lg btn-primary" style="display:none;">
