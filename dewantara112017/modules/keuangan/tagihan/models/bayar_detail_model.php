...
class Bayar_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('bayar_detail', $limit, $uri);
    ...
    function ceknomornull(){
        ...
        $result=$this->db->get('bayar_detail');
    ...
    function savebayar_detail($data){
        $this->db->insert('bayar_detail',$data);
    }
    function save_detail($data){
        $this->db->insert('bayar_detail_detail',$data);
    }
    ...
    function delete_detail($id=null) {
        ...
        $this->db->delete('bayar_detail_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from bayar_detail order by id asc');
