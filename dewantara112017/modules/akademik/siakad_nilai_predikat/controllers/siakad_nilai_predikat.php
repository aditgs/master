...
class siakad_nilai_predikat extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','siakad_nilai_predikat');
    ...
    public function index() {
        $this->template->set_title('Kelola Siakad_nilai_predikat');
        $this->template->add_js('var baseurl="'.base_url().'siakad_nilai_predikat/";','embed');  
        $this->template->load_view('siakad_nilai_predikat_view',array(
            'view'=>'',
            'title'=>'Kelola Data Siakad_nilai_predikat',
            'subtitle'=>'Pengelolaan Siakad_nilai_predikat',
            'breadcrumb'=>array(
            'Siakad_nilai_predikat'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_nilai_predikat/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_nilai_predikat,kode_akademik,kode_prodi,nm_predikat,bts_bobot_awal,bts_bobot_akhir,')
                            ->from('siakad_nilai_predikat');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_nilai_predikat/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_nilai_predikat');
            $this->datatables->unset_column('id_siakad_nilai_predikat');
        endif;
