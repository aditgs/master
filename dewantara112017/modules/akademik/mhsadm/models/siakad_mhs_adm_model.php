...
class Siakad_mhs_adm_model extends CI_Model {
    ...
    function ceknomornull(){
        ...
        $result=$this->db->get('siakad_mhs_adm');
    ...
    function savesiakad_mhs_adm($data){
        $this->db->insert('siakad_mhs_adm',$data);
    }
    function save_detail($data){
        $this->db->insert('siakad_mhs_adm_detail',$data);
    }
    ...
    function delete($id) {
        $this->db->where('id', $id);
        $this->db->delete('siakad_mhs_adm'); 
       
    }
    function delete_detail($id=null) {
        $this->db->where('id_detail', $id);
        $this->db->delete('siakad_mhs_adm_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from siakad_mhs_adm order by id asc');
