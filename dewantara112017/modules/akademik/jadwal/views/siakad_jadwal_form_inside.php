                    ...
                    <?php echo form_open(base_url().'jadwal/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('hari_jadwal',set_value('hari_jadwal', isset($default['hari_jadwal']) ? $default['hari_jadwal'] : ''),'id="hari_jadwal" class="form-control" placeholder="Masukkan Hari Jadwal"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('jam_mulai',set_value('jam_mulai', isset($default['jam_mulai']) ? $default['jam_mulai'] : ''),'id="jam_mulai" class="form-control" placeholder="Masukkan Jam Mulai"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('jam_selesai',set_value('jam_selesai', isset($default['jam_selesai']) ? $default['jam_selesai'] : ''),'id="jam_selesai" class="form-control" placeholder="Masukkan Jam Selesai"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('kapasitas_ruang',set_value('kapasitas_ruang', isset($default['kapasitas_ruang']) ? $default['kapasitas_ruang'] : ''),'id="kapasitas_ruang" class="form-control" placeholder="Masukkan Kapasitas Ruang"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('tatap_muka',set_value('tatap_muka', isset($default['tatap_muka']) ? $default['tatap_muka'] : ''),'id="tatap_muka" class="form-control" placeholder="Masukkan Tatap Muka"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('inisial_kelas_jadwal',set_value('inisial_kelas_jadwal', isset($default['inisial_kelas_jadwal']) ? $default['inisial_kelas_jadwal'] : ''),'id="inisial_kelas_jadwal" class="form-control" placeholder="Masukkan Inisial Jadwal"'); ?>
                                </div>
                            </div>
