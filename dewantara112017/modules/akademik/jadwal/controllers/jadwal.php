...
class jadwal extends MX_Controller {
    ...
    public function index() {
        $this->template->set_title('Kelola Jadwal');
        $this->template->add_js('var baseurl="'.base_url().'jadwal/";','embed');  
        $this->template->load_view('siakad_jadwal_view',array(
            'view'=>'',
            'title'=>'Kelola Data Jadwal',
            'subtitle'=>'Pengelolaan Jadwal',
            'breadcrumb'=>array(
            'Jadwal'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('jadwal/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_jadwal,kode_akademik,kode_prodi,kode_mk,hari_jadwal,jam_mulai,jam_selesai,id_siakad_ruang,kapasitas_ruang,tatap_muka,inisial_kelas_jadwal,nip_dosen,')
                            ->from('siakad_jadwal');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('jadwal/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_jadwal');
            $this->datatables->unset_column('id_siakad_jadwal');
        endif;
