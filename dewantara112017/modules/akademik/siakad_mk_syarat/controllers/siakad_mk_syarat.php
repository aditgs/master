...
class siakad_mk_syarat extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','siakad_mk_syarat');
    ...
    public function index() {
        $this->template->set_title('Kelola Siakad_mk_syarat');
        $this->template->add_js('var baseurl="'.base_url().'siakad_mk_syarat/";','embed');  
        $this->template->load_view('siakad_mk_syarat_view',array(
            'view'=>'',
            'title'=>'Kelola Data Siakad_mk_syarat',
            'subtitle'=>'Pengelolaan Siakad_mk_syarat',
            'breadcrumb'=>array(
            'Siakad_mk_syarat'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_mk_syarat/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_mk_syarat,kode_prodi,kode_mk_main,kode_mk_syarat,nil_mk_syarat,nil_angka_mk_syarat,')
                            ->from('siakad_mk_syarat');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_mk_syarat/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_mk_syarat');
            $this->datatables->unset_column('id_siakad_mk_syarat');
        endif;
