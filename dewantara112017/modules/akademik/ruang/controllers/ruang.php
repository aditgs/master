...
class ruang extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','ruang');
    ...
    public function index() {
        $this->template->set_title('Kelola Ruang');
        $this->template->add_js('var baseurl="'.base_url().'ruang/";','embed');  
        $this->template->load_view('siakad_ruang_view',array(
            'view'=>'',
            'title'=>'Kelola Data Ruang',
            'subtitle'=>'Pengelolaan Ruang',
            'breadcrumb'=>array(
            'Ruang'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('ruang/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_ruang,inisial_ruangan,nm_ruangan,')
                            ->from('siakad_ruang');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('ruang/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_ruang');
            $this->datatables->unset_column('id_siakad_ruang');
        endif;
