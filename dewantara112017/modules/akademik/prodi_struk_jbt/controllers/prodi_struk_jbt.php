...
class prodi_struk_jbt extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','prodi_struk_jbt');
    ...
    public function index() {
        $this->template->set_title('Kelola Prodi Struktur Jabatan');
        $this->template->add_js('var baseurl="'.base_url().'prodi_struk_jbt/";','embed');  
        $this->template->load_view('siakad_prodi_struk_jbt_view',array(
            'view'=>'',
            'title'=>'Kelola Data Prodi Struktur Jabatan',
            'subtitle'=>'Pengelolaan Prodi Struktur Jabatan',
            'breadcrumb'=>array(
            'Prodi Struktur Jabatan'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('prodi_struk_jbt/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_prodi_struk_jbt,kode_prodi,nm_prodi_jabatan,def_pos_surat,')
                            ->from('siakad_prodi_struk_jbt');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('prodi_struk_jbt/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_prodi_struk_jbt');
            $this->datatables->unset_column('id_siakad_prodi_struk_jbt');
        endif;
