...
<div id="form_input" class="row gutter5">
    <?php echo form_open(base_url().'mk_paket/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="form-group">
            <?php echo form_label('Nama Paket MK : ','nm_paket_mk',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php echo form_input('nm_paket_mk',set_value('nm_paket_mk', isset($default['nm_paket_mk']) ? $default['nm_paket_mk'] : ''),'id="nm_paket_mk" class="form-control" placeholder="Masukkan nama paket mk"'); ?>
            </div>
        </div>
        
        <div class="form-group">
            <?php echo form_label('Status Paket MK : ','status_paket_mk',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php echo form_input('status_paket_mk',set_value('status_paket_mk', isset($default['status_paket_mk']) ? $default['status_paket_mk'] : ''),'id="status_paket_mk" class="form-control" placeholder="Masukkan status paket mk"'); ?>
            </div>
        </div>
