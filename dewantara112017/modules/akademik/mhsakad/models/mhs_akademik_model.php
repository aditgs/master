...
class Mhs_akademik_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('mhs_akademik', $limit, $uri);
    ...
    function ceknomornull(){
        ...
        $result=$this->db->get('mhs_akademik');
    ...
    function __save(){
       ...
       $data = array(
            ...
            'tahunakad' => $this->input->post('tahunakad', TRUE),
           
            'isactive' => $this->input->post('isactive', TRUE),
           
            'dateactive' => $this->input->post('dateactive', TRUE),
    ...
    function savemhs_akademik($data){
        $this->db->insert('mhs_akademik',$data);
    }
    function save_detail($data){
        $this->db->insert('mhs_akademik_detail',$data);
    }
    ...
    function delete($id) {
        $this->db->where('id', $id);
        $this->db->delete('mhs_akademik'); 
       
    }
    function delete_detail($id=null) {
        $this->db->where('id_detail', $id);
        $this->db->delete('mhs_akademik_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from mhs_akademik order by id asc');
