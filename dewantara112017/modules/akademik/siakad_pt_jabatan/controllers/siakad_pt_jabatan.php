...
class siakad_pt_jabatan extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','siakad_pt_jabatan');
    ...
    public function index() {
        $this->template->set_title('Kelola Siakad_pt_jabatan');
        $this->template->add_js('var baseurl="'.base_url().'siakad_pt_jabatan/";','embed');  
        $this->template->load_view('siakad_pt_jabatan_view',array(
            'view'=>'',
            'title'=>'Kelola Data Siakad_pt_jabatan',
            'subtitle'=>'Pengelolaan Siakad_pt_jabatan',
            'breadcrumb'=>array(
            'Siakad_pt_jabatan'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_pt_jabatan/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_pt_jabatan,id_siakad_pt_struk_jbt,nip_pejabat,periode_jbt_awal,periode_jbt_akhir,')
                            ->from('siakad_pt_jabatan');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_pt_jabatan/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_pt_jabatan');
            $this->datatables->unset_column('id_siakad_pt_jabatan');
        endif;
