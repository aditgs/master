...
class siakad_jadwal_absen extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','siakad_jadwal_absen');
    ...
    public function index() {
        $this->template->set_title('Kelola Siakad_jadwal_absen');
        $this->template->add_js('var baseurl="'.base_url().'siakad_jadwal_absen/";','embed');  
        $this->template->load_view('siakad_jadwal_absen_view',array(
            'view'=>'',
            'title'=>'Kelola Data Siakad_jadwal_absen',
            'subtitle'=>'Pengelolaan Siakad_jadwal_absen',
            'breadcrumb'=>array(
            'Siakad_jadwal_absen'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_jadwal_absen/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_jadwal_ujian,id_siakad_jadwal,nim_mhs,pertemuan_mk,')
                            ->from('siakad_jadwal_absen');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_jadwal_absen/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_jadwal_ujian');
            $this->datatables->unset_column('id_siakad_jadwal_ujian');
        endif;
