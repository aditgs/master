...
class siakad_mhs_ta extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','siakad_mhs_ta');
    ...
    public function index() {
        $this->template->set_title('Kelola Siakad_mhs_ta');
        $this->template->add_js('var baseurl="'.base_url().'siakad_mhs_ta/";','embed');  
        $this->template->load_view('siakad_mhs_ta_view',array(
            'view'=>'',
            'title'=>'Kelola Data Siakad_mhs_ta',
            'subtitle'=>'Pengelolaan Siakad_mhs_ta',
            'breadcrumb'=>array(
            'Siakad_mhs_ta'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_mhs_ta/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_mhs_ta,nim_mhs,kode_akademik,judul_ta,abstrak_ta,kata_kunci_ta,bln_awal_bimbingan,thn_awal_bimbingan,bln_akhir_bimbingan,thn_akhir_bimbingan,nip_dosen_1,nip_dosen_2,')
                            ->from('siakad_mhs_ta');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_mhs_ta/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_mhs_ta');
            $this->datatables->unset_column('id_siakad_mhs_ta');
        endif;
