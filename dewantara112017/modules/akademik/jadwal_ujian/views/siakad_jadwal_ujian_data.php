<div class="datatable-ajax-source">
    <div class="btn-group" style="margin:20px 0px 30px">
        ...
        <a href="<?php echo base_url('jadwal_ujian/baru') ?>" class="btn btn-lg btn-success"><i class="fa fa-plus"></i> Buka Jadwal Ujian Baru </a>
        <a href="<?php echo base_url('jadwal_ujian') ?>" class="btn btn-lg btn-info"><i class="fa fa-database"></i> Data Jadwal Ujian</a>
    </div>
