...
class Siakad_jadwal_ujian_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('siakad_jadwal_ujian', $limit, $uri);
    ...
    function ceknomornull(){
        ...
        $result=$this->db->get('siakad_jadwal_ujian');
    ...
    function gettotaldetail($faktur){
        ...
        $this->db->from('siakad_jadwal_ujian');
    ...
    function savesiakad_jadwal_ujian($data){
        $this->db->insert('siakad_jadwal_ujian',$data);
    }
    function save_detail($data){
        $this->db->insert('siakad_jadwal_ujian_detail',$data);
    }
    ...
    function delete($id_siakad_jadwal_ujian) {
        $this->db->where('id_siakad_jadwal_ujian', $id_siakad_jadwal_ujian);
        $this->db->delete('siakad_jadwal_ujian'); 
       
    }
    function delete_detail($id=null) {
        $this->db->where('id_detail', $id);
        $this->db->delete('siakad_jadwal_ujian_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id_siakad_jadwal_ujian, '.$value.' from siakad_jadwal_ujian order by id_siakad_jadwal_ujian asc');
