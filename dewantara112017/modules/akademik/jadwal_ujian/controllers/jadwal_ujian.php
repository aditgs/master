...
class jadwal_ujian extends MX_Controller {
    ...
    public function index() {
        ...
        $this->template->add_js('var baseurl="'.base_url().'jadwal_ujian/";','embed');  
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('jadwal_ujian/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_jadwal_ujian,kode_prodi,id_siakad_jadwal,jenis_ujian,tgl_ujian,ujian_mulai,ujian_selesai,id_siakad_ruang,nip_dosen,')
                            ->from('siakad_jadwal_ujian');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('jadwal_ujian/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_jadwal_ujian');
            $this->datatables->unset_column('id_siakad_jadwal_ujian');
        endif;
