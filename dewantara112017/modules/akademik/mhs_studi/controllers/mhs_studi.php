...
class mhs_studi extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','mhs_studi');
    ...
    public function index() {
        ...
        $this->template->add_js('var baseurl="'.base_url().'mhs_studi/";','embed');  
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('mhs_studi/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_mhs_studi,nim_mhs,id_siakad_jadwal,kode_akademik,kode_mk,status_studi,nil_tugas,nil_uts,nil_uas,nil_akhir,nilai_angka_studi,nilai_huruf_studi,status_nil_mk,status_val_studi,')
                            ->from('siakad_mhs_studi');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('mhs_studi/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_mhs_studi');
            $this->datatables->unset_column('id_siakad_mhs_studi');
        endif;
