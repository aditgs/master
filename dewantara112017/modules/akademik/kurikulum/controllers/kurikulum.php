...
class kurikulum extends MX_Controller {
    ...
    public function index() {
        $this->template->set_title('Kelola Kurikulum');
        $this->template->add_js('var baseurl="'.base_url().'kurikulum/";','embed');  
        $this->template->load_view('siakad_kurikulum_view',array(
            'view'=>'',
            'title'=>'Kelola Data Kurikulum',
            'subtitle'=>'Pengelolaan Kurikulum',
            'breadcrumb'=>array(
            'Kurikulum'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('kurikulum/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_kurikulum,kode_prodi,kode_kurikulum,nm_kurikulum,')
                            ->from('siakad_kurikulum');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('kurikulum/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_kurikulum');
            $this->datatables->unset_column('id_siakad_kurikulum');
        endif;
