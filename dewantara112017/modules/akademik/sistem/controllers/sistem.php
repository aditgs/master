...
class sistem extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','sistem');
    ...
    public function index() {
        $this->template->set_title('Kelola Sistem');
        $this->template->add_js('var baseurl="'.base_url().'sistem/";','embed');  
        $this->template->load_view('siakad_sistem_view',array(
            'view'=>'',
            'title'=>'Kelola Data Sistem',
            'subtitle'=>'Pengelolaan Sistem',
            'breadcrumb'=>array(
            'Sistem'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('sistem/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id_siakad_sistem,thn_akademik,kode_akademik,status_akademik,smtr_akademik,tgl_start_akademik,tgl_end_akademik,')
                            ->from('siakad_sistem');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('sistem/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id_siakad_sistem');
            $this->datatables->unset_column('id_siakad_sistem');
        endif;
